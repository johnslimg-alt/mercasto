...
```text
  ...
  DELETE    api/admin/reports/{id} ............. Api\AdController@deleteReport
            ⇂ api
            ⇂ Illuminate\Auth\Middleware\Authenticate:sanctum
  PATCH     api/admin/reports/{id}/lifecycle Api\AdminReportLifecycleController@transitionListing
            ⇂ api
            ⇂ Illuminate\Auth\Middleware\Authenticate:sanctum
            ⇂ Illuminate\Routing\Middleware\ThrottleRequests:api
  ...
  DELETE    api/admin/user-reports/{id} Api\ProfileController@deleteUserReport
            ⇂ api
            ⇂ Illuminate\Auth\Middleware\Authenticate:sanctum
  PATCH     api/admin/user-reports/{id}/lifecycle Api\AdminReportLifecycleController@transitionUser
            ⇂ api
            ⇂ Illuminate\Auth\Middleware\Authenticate:sanctum
            ⇂ Illuminate\Routing\Middleware\ThrottleRequests:api
  ...
  POST      api/contact ................................... routes/api.php:367
            ⇂ api
