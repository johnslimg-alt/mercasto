...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    /**
     * Campaign attribution captured at registration (CAC / cost-per-signup joins).
     */
    public function registrationAttribution(): HasOne
    {
        return $this->hasOne(UserRegistrationAttribution::class);
    }
