...
class NormalizeCatalogFillerImagesTest extends TestCase
{
    ...
    public function test_semantic_remap_is_dry_run_by_default_and_only_updates_catalog_fillers(): void
    {
        ...
        $cases = [
            ...
            ['turismo', 'Renta de Moto Acuática Yamaha Waverunner', 'water_sport'],
            ['turismo', 'Renta de Kayak Doble para Paseos', 'water_sport'],
            ...
            ['mascotas', 'Bebedero de fuente con filtro', 'pet_feeder'],
            ['mascotas', 'Bolsa transportadora aprobada por aerolíneas', 'pet_carrier'],
            ...
            ['electronica', 'Cable USB-C a Lightning', 'electronics_mobile_accessory'],
            ['electronica', 'Thermostato inteligente Ecobee', 'electronics_smart_home'],
            ...
            ['electronica', 'Audífonos Sony WH-1000XM5', 'electronics_headphones'],
            ['electronica', 'Soundbar Bose Smart 600', 'electronics_speaker'],
            ['electronica', 'Micrófono condensador USB', 'electronics_microphone'],
