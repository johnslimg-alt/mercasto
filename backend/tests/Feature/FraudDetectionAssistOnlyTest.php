...
class FraudDetectionAssistOnlyTest extends TestCase
{
    ...
    public function test_high_risk_score_is_persisted_without_mutating_listing_status(): void
    {
        config(['fraud_risk.thresholds.review' => 40]);
        ...
        $this->assertSame('assist_only', $result['mode']);
