...
test('admin route hides marketplace catalog search and category navigation', () => {
  ...
  assert.ok(header.includes('(isAdminRoute || hideMobileSearch) ? "hidden" : "mobile-search-row py-2.5 lg:hidden"'));
  ...
  assert.ok(app.includes('hideMobileSearch={isHomeV2Route}'));
