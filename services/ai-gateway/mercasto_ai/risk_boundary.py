...
_RISK_BATCH_PATH = "/v1/risk/batch"
_MAX_RISK_REQUEST_BODY_BYTES = 128 * 1024


class RiskRequestBoundaryMiddleware:
    """Authenticate and bound risk bodies before FastAPI JSON parsing."""
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        if (
            ...
            or scope.get("path") != _RISK_BATCH_PATH
        ):
