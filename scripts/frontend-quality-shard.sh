...
case "${shard}" in
  ...
  localized-public)
    BASE_URL="${base_url}" CI=1 npx playwright test \
      ...
      tests/e2e/blog-golden-shell.spec.js tests/e2e/golden-mobile-registry-31-38.spec.js \
  ...
  journey)
    BASE_URL="${base_url}" CI=1 npx playwright test \
      ...
      tests/e2e/catalog-reference-labelling-headings.spec.js \
      tests/e2e/listing-metadata-authority.spec.js \
  ...
  catalog)
    BASE_URL="${base_url}" CI=1 npx playwright test \
      ...
      tests/e2e/color-contrast-accessibility.spec.js \
      tests/e2e/tap-target-accessibility.spec.js \
