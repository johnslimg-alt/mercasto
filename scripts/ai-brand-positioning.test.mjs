...
const expectedShortTags = {"es": "Clasificados AI", "en": "AI Classifieds", "pt": "Classificados AI", "fr": "Annonces AI", "de": "KI-Kleinanzeigen", "it": "Annunci AI", "ru": "AI-объявления", "zh": "AI 分类", "ja": "AIクラシファイド", "ko": "AI 광고", "ar": "إعلانات AI", "he": "מודעות AI", "yi": "AI־מודעות"};
...
const canonicalShort = { es: 'Clasificados AI', en: 'AI Classifieds', ru: 'AI-объявления' };
...
test('every supported language carries the AI brand contract', async () => {
  for (const language of languages) {
    ...
    assert.equal(dictionary.ai_brand_short, expectedShortTags[language], `${language}: exact compact AI tag`);
