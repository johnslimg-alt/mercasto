...
OLLAMA_CONTAINER="${E2E_OLLAMA_CONTAINER:-mercasto-launch-e2e-ollama}"
...
OLLAMA_HOST_PORT="${OLLAMA_E2E_HOST_PORT:-18002}"
...
RESET_EMAIL_DESKTOP="${E2E_RESET_EMAIL_DESKTOP:-reset_desktop_e2e@mercasto.com}"
RESET_TOKEN_DESKTOP="${E2E_RESET_TOKEN_DESKTOP:-reset-token-desktop-e2e}"
RESET_EMAIL_MOBILE="${E2E_RESET_EMAIL_MOBILE:-reset_mobile_e2e@mercasto.com}"
RESET_TOKEN_MOBILE="${E2E_RESET_TOKEN_MOBILE:-reset-token-mobile-e2e}"
RESET_NEW_PASSWORD="${E2E_RESET_NEW_PASSWORD:-E2eNewPass99!}"
TWO_FACTOR_EMAIL_DESKTOP="${E2E_2FA_EMAIL_DESKTOP:-twofactor_desktop_e2e@mercasto.com}"
TWO_FACTOR_PASSWORD_DESKTOP="${E2E_2FA_PASSWORD_DESKTOP:-E2eTestPass99!}"
TWO_FACTOR_RECOVERY_DESKTOP="${E2E_2FA_RECOVERY_DESKTOP:-desktop-recovery-e2e}"
TWO_FACTOR_EMAIL_MOBILE="${E2E_2FA_EMAIL_MOBILE:-twofactor_mobile_e2e@mercasto.com}"
TWO_FACTOR_PASSWORD_MOBILE="${E2E_2FA_PASSWORD_MOBILE:-E2eTestPass99!}"
TWO_FACTOR_RECOVERY_MOBILE="${E2E_2FA_RECOVERY_MOBILE:-mobile-recovery-e2e}"
...
cleanup() {
  ...
  docker rm -f "$API_CONTAINER" "$POSTGRES_CONTAINER" "$CLIP_CONTAINER" "$OLLAMA_CONTAINER" >/dev/null 2>&1 || true
...
docker run -d --name "$OLLAMA_CONTAINER" --network "$NETWORK" \
  ...
  node:22-alpine node /app/ollama-e2e-mock.mjs >/dev/null
if ! wait_for_url "http://127.0.0.1:$OLLAMA_HOST_PORT/health" "Ollama fallback mock"; then
...
common_env=(
  ...
  -e E2E_RESET_EMAIL_DESKTOP="$RESET_EMAIL_DESKTOP"
  -e E2E_RESET_TOKEN_DESKTOP="$RESET_TOKEN_DESKTOP"
  -e E2E_RESET_EMAIL_MOBILE="$RESET_EMAIL_MOBILE"
  -e E2E_RESET_TOKEN_MOBILE="$RESET_TOKEN_MOBILE"
  -e E2E_2FA_EMAIL_DESKTOP="$TWO_FACTOR_EMAIL_DESKTOP"
  -e E2E_2FA_PASSWORD_DESKTOP="$TWO_FACTOR_PASSWORD_DESKTOP"
  -e E2E_2FA_RECOVERY_DESKTOP="$TWO_FACTOR_RECOVERY_DESKTOP"
  -e E2E_2FA_EMAIL_MOBILE="$TWO_FACTOR_EMAIL_MOBILE"
  -e E2E_2FA_PASSWORD_MOBILE="$TWO_FACTOR_PASSWORD_MOBILE"
  -e E2E_2FA_RECOVERY_MOBILE="$TWO_FACTOR_RECOVERY_MOBILE"
...
base_env=(
  ...
  E2E_RESET_EMAIL_DESKTOP="$RESET_EMAIL_DESKTOP"
  E2E_RESET_TOKEN_DESKTOP="$RESET_TOKEN_DESKTOP"
  E2E_RESET_EMAIL_MOBILE="$RESET_EMAIL_MOBILE"
  E2E_RESET_TOKEN_MOBILE="$RESET_TOKEN_MOBILE"
  E2E_RESET_NEW_PASSWORD="$RESET_NEW_PASSWORD"
  E2E_2FA_EMAIL_DESKTOP="$TWO_FACTOR_EMAIL_DESKTOP"
  E2E_2FA_PASSWORD_DESKTOP="$TWO_FACTOR_PASSWORD_DESKTOP"
  E2E_2FA_RECOVERY_DESKTOP="$TWO_FACTOR_RECOVERY_DESKTOP"
  E2E_2FA_EMAIL_MOBILE="$TWO_FACTOR_EMAIL_MOBILE"
  E2E_2FA_PASSWORD_MOBILE="$TWO_FACTOR_PASSWORD_MOBILE"
  E2E_2FA_RECOVERY_MOBILE="$TWO_FACTOR_RECOVERY_MOBILE"
  CLIP_WEBHOOK_SECRET="$WEBHOOK_SECRET"
  CLIP_E2E_PUBLIC_BASE_URL="http://127.0.0.1:$CLIP_PORT"
  CI=1
)
