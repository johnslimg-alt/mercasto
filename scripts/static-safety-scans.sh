...
bash scripts/self-hosted-workflow-tempfile-gate.sh
...
bash scripts/gamification-activity-endpoint-gate.sh
bash scripts/sensitive-profile-reauth-gate.sh
...
bash scripts/deploy-freeze-window.test.sh
