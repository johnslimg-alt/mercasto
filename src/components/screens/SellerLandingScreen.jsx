...
const TRANSLATIONS = {
  es: {
    ...
    seo_title: 'Publica anuncios en México | Empieza gratis en Mercasto',
    badge: 'Plan gratis: hasta 3 anuncios al mes',
    ...
    hero_title_after: "",
    hero_desc: 'Activa gratis durante 7 días tu anuncio elegible. El plan gratuito incluye hasta 3 anuncios al mes y los compradores te contactan directamente.',
    ...
    faq_a1: 'El plan gratuito cuesta $0 al mes e incluye hasta 3 anuncios al mes. La primera activación elegible dura 7 días sin costo; renovar otros 7 días cuesta $49 MXN. Mercasto no cobra comisión sobre la venta.',
    ...
    faq_a4: 'El plan gratuito permite hasta 3 anuncios al mes. Para publicar más existen planes de pago; las condiciones vigentes se muestran en Tarifas.',
    ...
    cta_footer_desc: 'Empieza con el plan gratuito: hasta 3 anuncios al mes y primera activación elegible por 7 días sin costo.',
    cta_footer_btn: 'Empezar Ahora'
  },
  en: {
    ai_brand_tagline: 'The most modern and intelligent AI-powered classifieds platform',
    seo_title: 'Post Classified Ads in Mexico | Start Free with Mercasto',
    badge: 'Free plan: up to 3 listings per month',
    ...
    hero_title_after: "",
    hero_desc: 'Activate an eligible listing free for 7 days. The free plan includes up to 3 listings per month, with buyers contacting you directly.',
    cta_btn: 'Start free',
    ...
    faq_a1: 'The free plan costs $0 per month and includes up to 3 listings per month. The first eligible activation is free for 7 days; renewing for another 7 days costs $49 MXN. Mercasto does not charge a sales commission.',
    ...
    faq_a4: 'The free plan allows up to 3 listings per month. Paid plans are available for higher volume; current terms are shown on the Pricing page.',
    ...
    cta_footer_desc: 'Start with the free plan: up to 3 listings per month and a free 7-day first eligible activation.',
    cta_footer_btn: 'Get Started'
  },
  pt: {
    ai_brand_tagline: 'A plataforma de classificados mais moderna e inteligente com AI',
    seo_title: 'Publique anúncios no México | Comece grátis no Mercasto',
    badge: 'Plano grátis: até 3 anúncios por mês',
    ...
    hero_title_after: "",
    hero_desc: 'Ative gratuitamente por 7 dias um anúncio elegível. O plano grátis inclui até 3 anúncios por mês e contato direto com compradores.',
    ...
    faq_a1: 'O plano grátis custa $0 por mês e inclui até 3 anúncios por mês. A primeira ativação elegível é gratuita por 7 dias; renovar por mais 7 dias custa $49 MXN. O Mercasto não cobra comissão sobre a venda.',
    ...
    faq_a4: 'O plano grátis permite até 3 anúncios por mês. Para maior volume, há planos pagos; as condições atuais aparecem em Tarifas.',
    ...
    cta_footer_desc: 'Comece com o plano grátis: até 3 anúncios por mês e primeira ativação elegível gratuita por 7 dias.',
    cta_footer_btn: 'Começar Agora'
  },
  fr: {
    ai_brand_tagline: 'La plateforme de petites annonces la plus moderne et intelligente avec IA',
    seo_title: 'Publiez des annonces au Mexique | Commencez gratuitement avec Mercasto',
    badge: 'Forfait gratuit : jusqu’à 3 annonces par mois',
    ...
    hero_title_after: "",
    hero_desc: 'Activez gratuitement pendant 7 jours une annonce éligible. Le forfait gratuit inclut jusqu’à 3 annonces par mois et le contact direct avec les acheteurs.',
    ...
    faq_a1: 'Le forfait gratuit coûte $0 par mois et inclut jusqu’à 3 annonces par mois. La première activation éligible est gratuite pendant 7 jours ; un renouvellement de 7 jours coûte $49 MXN. Mercasto ne prélève pas de commission sur la vente.',
    ...
    faq_a4: 'Le forfait gratuit permet jusqu’à 3 annonces par mois. Des forfaits payants existent pour un volume supérieur ; les conditions en vigueur sont indiquées dans Tarifs.',
    ...
    cta_footer_desc: 'Commencez avec le forfait gratuit : jusqu’à 3 annonces par mois et première activation éligible gratuite pendant 7 jours.',
  ...
  de: {
    ...
    seo_title: 'Kleinanzeigen in Mexiko veröffentlichen | Kostenlos mit Mercasto starten',
    badge: 'Kostenloser Plan: bis zu 3 Anzeigen pro Monat',
    ...
    hero_title_after: "",
    hero_desc: 'Aktivieren Sie eine geeignete Anzeige 7 Tage kostenlos. Der kostenlose Plan umfasst bis zu 3 Anzeigen pro Monat und direkten Käuferkontakt.',
    ...
    faq_a1: 'Der kostenlose Plan kostet $0 pro Monat und umfasst bis zu 3 Anzeigen pro Monat. Die erste geeignete Aktivierung ist 7 Tage kostenlos; weitere 7 Tage kosten $49 MXN. Mercasto erhebt keine Verkaufsprovision.',
    ...
    faq_a4: 'Der kostenlose Plan erlaubt bis zu 3 Anzeigen pro Monat. Für mehr Volumen gibt es kostenpflichtige Pläne; die aktuellen Bedingungen stehen unter Tarife.',
    ...
    cta_footer_desc: 'Starten Sie mit dem kostenlosen Plan: bis zu 3 Anzeigen pro Monat und eine kostenlose 7-tägige erste geeignete Aktivierung.',
    cta_footer_btn: 'Jetzt starten'
  },
  it: {
    ai_brand_tagline: 'La piattaforma di annunci più moderna e intelligente con AI',
    seo_title: 'Pubblica annunci in Messico | Inizia gratis con Mercasto',
    badge: 'Piano gratuito: fino a 3 annunci al mese',
    ...
    hero_title_after: "",
    hero_desc: 'Attiva gratuitamente per 7 giorni un annuncio idoneo. Il piano gratuito include fino a 3 annunci al mese e contatto diretto con gli acquirenti.',
    ...
    faq_a4: 'Il piano gratuito consente fino a 3 annunci al mese. Per volumi maggiori sono disponibili piani a pagamento; le condizioni aggiornate sono indicate in Tariffe.',
    ...
    cta_footer_desc: 'Inizia con il piano gratuito: fino a 3 annunci al mese e prima attivazione idonea gratuita per 7 giorni.',
    cta_footer_btn: 'Inizia ora'
  },
  ru: {
    ai_brand_tagline: 'Самая современная и умная доска объявлений с AI',
    seo_title: 'Объявления в Мексике | Начните бесплатно с Mercasto',
    badge: 'Бесплатный план: до 3 объявлений в месяц',
    hero_title: 'Продавайте быстрее и без комиссии',
    hero_title_before: "Продавайте быстрее и ",
    hero_title_highlight: "без комиссии",
    hero_title_after: "",
    hero_desc: 'Активируйте подходящее объявление бесплатно на 7 дней. Бесплатный план включает до 3 объявлений в месяц и прямой контакт с покупателями.',
    ...
    faq_a1: 'Бесплатный план стоит $0 в месяц и включает до 3 объявлений в месяц. Первая активация подходящего объявления бесплатна на 7 дней; продление ещё на 7 дней стоит $49 MXN. Mercasto не берет комиссию с продажи.',
    ...
    faq_a4: 'Бесплатный план позволяет публиковать до 3 объявлений в месяц. Для большего объёма доступны платные планы; актуальные условия указаны в разделе «Тарифы».',
    ...
    cta_footer_desc: 'Начните с бесплатного плана: до 3 объявлений в месяц и первая подходящая активация бесплатно на 7 дней.',
    cta_footer_btn: 'Начать сейчас'
  },
  zh: {
    ai_brand_tagline: '最现代、最智能的 AI 分类信息平台',
    seo_title: '在墨西哥发布分类广告 | 免费开始使用 Mercasto',
    badge: '免费套餐：每月最多 3 个广告',
    hero_title: '销售更快且无需支付佣金',
    hero_title_before: "销售更快且",
    hero_title_highlight: "无需支付佣金",
    hero_title_after: "",
    hero_desc: '符合条件的广告首次可免费激活 7 天。免费套餐每月最多包含 3 个广告，买家可直接联系您。',
    cta_btn: '免费开始',
    ...
    faq_a1: '免费套餐月费为 $0，每月最多包含 3 个广告。符合条件的广告首次激活可免费展示 7 天；再续 7 天需 $49 MXN。Mercasto 不收取销售佣金。',
  ...
  ja: {
    ...
    seo_title: 'メキシコでクラシファイド広告を掲載 | Mercastoを無料で開始',
    badge: '無料プラン：月3件まで掲載',
    hero_title: '手数料なしでより速く売却',
    hero_title_before: "",
    hero_title_highlight: "手数料なしで",
    hero_title_after: "より速く売却",
    hero_desc: '対象広告の初回有効化は7日間無料です。無料プランは月3件まで掲載でき、購入希望者と直接連絡できます。',
    cta_btn: '無料で始める',
    ...
    faq_a1: '無料プランは月額 $0 で、月3件まで掲載できます。対象広告の初回有効化は7日間無料で、さらに7日間更新する場合は $49 MXN です。Mercasto は販売手数料を取りません。',
    ...
    faq_a4: '無料プランは月3件まで掲載できます。より多く掲載する場合は有料プランがあり、最新条件は料金ページに表示されます。',
    ...
    cta_footer_desc: '無料プランから開始：月3件まで、対象広告の初回有効化は7日間無料です。',
    cta_footer_btn: '今すぐ始める'
  },
  ko: {
    ai_brand_tagline: '가장 현대적이고 스마트한 AI 기반 분류 광고 플랫폼',
    seo_title: '멕시코 분류 광고 등록 | Mercasto 무료 시작',
    badge: '무료 플랜: 월 최대 3개 광고',
    hero_title: '수수료 없이 더 빠르게 판매하세요',
    hero_title_before: "",
    hero_title_highlight: "수수료 없이",
    hero_title_after: " 더 빠르게 판매하세요",
    hero_desc: '대상 광고의 첫 활성화는 7일간 무료입니다. 무료 플랜은 월 최대 3개 광고를 포함하며 구매자와 직접 연락할 수 있습니다.',
    cta_btn: '무료로 시작',
    ...
    faq_a1: '무료 플랜은 월 $0이며 월 최대 3개 광고를 포함합니다. 대상 광고의 첫 활성화는 7일간 무료이고, 추가 7일 갱신은 $49 MXN입니다. Mercasto는 판매 수수료를 받지 않습니다.',
    ...
    faq_a4: '무료 플랜은 월 최대 3개 광고를 허용합니다. 더 많은 등록이 필요하면 유료 플랜을 이용할 수 있으며 최신 조건은 요금 페이지에 표시됩니다.',
    ...
    cta_footer_desc: '무료 플랜으로 시작하세요: 월 최대 3개 광고, 대상 광고 첫 활성화는 7일간 무료입니다.',
    cta_footer_btn: '지금 시작하기'
  },
  ar: {
    ai_brand_tagline: 'أحدث وأذكى منصة إعلانات مبوبة مدعومة بالذكاء الاصطناعي',
    seo_title: 'انشر إعلانات في المكسيك | ابدأ مجانًا مع Mercasto',
    badge: 'الخطة المجانية: حتى 3 إعلانات شهريًا',
    hero_title: 'بع أسرع وبدون دفع أي عمولات',
    hero_title_before: "بع أسرع و",
    hero_title_highlight: "بدون دفع أي عمولات",
    hero_title_after: "",
    hero_desc: 'فعّل إعلانًا مؤهلًا مجانًا لمدة 7 أيام. تشمل الخطة المجانية حتى 3 إعلانات شهريًا مع تواصل مباشر مع المشترين.',
    cta_btn: 'ابدأ مجانًا',
    ...
    faq_a1: 'الخطة المجانية تكلف $0 شهريًا وتشمل حتى 3 إعلانات شهريًا. أول تفعيل مؤهل مجاني لمدة 7 أيام؛ التجديد لمدة 7 أيام إضافية يكلف $49 MXN. لا يتقاضى Mercasto عمولة على البيع.',
    ...
    faq_a4: 'تسمح الخطة المجانية بما يصل إلى 3 إعلانات شهريًا. تتوفر خطط مدفوعة لحجم أكبر، وتظهر الشروط الحالية في صفحة الأسعار.',
    ...
    cta_footer_desc: 'ابدأ بالخطة المجانية: حتى 3 إعلانات شهريًا وأول تفعيل مؤهل مجاني لمدة 7 أيام.',
