      ...
      <div className="max-w-6xl mx-auto px-4 py-10 space-y-14">
        <section>
          <div className="mb-4 flex items-end justify-between gap-3">
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Propiedades en el mapa</h2>
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Busca casas, departamentos y locales con filtros en pantalla completa.</p>
            </div>
