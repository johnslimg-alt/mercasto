  ...
  return (
    <>
      ...
      <div className="p-4 md:p-8 w-full max-w-[1400px] mx-auto">
            ...
            {dashboardTab === 'my_ads' ? (
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm">
                ...
                <div className="divide-y divide-slate-100 dark:divide-slate-700">
                  {favoriteAdsLoading && displayedAds.length === 0 ? (
                    <div data-testid="dashboard-favorites-loading" role="status" aria-live="polite" className="flex items-center justify-center py-12">
                      <Loader2 className="w-8 h-8 animate-spin text-lime-500" aria-hidden="true" />
                    </div>
                    ...
                    <div data-testid="dashboard-favorites-empty" className="p-12 text-center">
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <select 
                      aria-label={t.stats_period || t.stats || 'Statistics period'}
                      value={analyticsDays}
        ...
        {accountType === 'particular' && (
          <div data-testid="dashboard-pro-upgrade-banner" className="mt-6 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-2xl p-8 text-white flex flex-col md:flex-row items-center justify-between shadow-2xl border border-slate-700">
