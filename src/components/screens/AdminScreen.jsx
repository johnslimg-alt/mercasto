        ...
        <div className="p-4 md:p-8 w-full max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            ...
            <div className="bg-slate-200 p-1 rounded-xl flex flex-wrap items-center gap-1 w-fit">
               ...
               <button type="button" aria-pressed={adminTab === 'coupons'} data-testid="admin-tab-coupons" onClick={() => {setAdminTab('coupons'); loadCoupons();}} className={`px-4 py-1.5 text-[13px] font-semibold rounded-lg transition-all ${adminTab === 'coupons' ? 'bg-white shadow-sm text-slate-900' : 'text-slate-500 hover:text-slate-700'}`}>{t.coupons_tab}</button>
