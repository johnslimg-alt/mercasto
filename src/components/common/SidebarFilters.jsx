  ...
  return (
    <section data-testid={testId || undefined} className="border-b border-slate-100 last:border-b-0 dark:border-slate-800">
      <button
        ...
        className="flex h-12 w-full items-center gap-2 rounded-lg px-1 text-left text-[12.5px] font-bold text-slate-800 transition-colors hover:text-[#4D7C0F] xl:h-10 dark:text-slate-100 dark:hover:text-[#BEF264]"
      >
...
export default function SidebarFilters({
  ...
  const inputClass = 'h-12 w-full px-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-xl text-[12.5px] text-slate-800 dark:text-slate-100 placeholder:text-slate-400 outline-none focus:border-[#84CC16] focus:bg-white xl:h-10 dark:focus:bg-slate-900 transition-colors';
  const selectClass = 'h-12 w-full pl-3 pr-8 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-xl text-[12.5px] text-slate-700 dark:text-slate-100 outline-none focus:border-[#84CC16] focus:bg-white xl:h-10 dark:focus:bg-slate-900 transition-colors cursor-pointer';
  const labelClass = 'flex min-h-12 items-center gap-2.5 text-[12.5px] text-slate-700 dark:text-slate-300 cursor-pointer hover:text-slate-900 xl:min-h-0 dark:hover:text-white transition-colors';
