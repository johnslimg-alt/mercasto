              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-200 dark:border-slate-800 flex flex-col shadow-sm">
                    <h4 className="font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider text-[11px] mb-1">{t.pm_plan_free}</h4>
                    <p className="text-2xl font-black text-slate-950 dark:text-white mb-3">$0 <span className="text-[12px] font-normal text-slate-400 dark:text-slate-500">{t.pm_per_month}</span></p>
                    <ul className="space-y-2 mb-6 flex-1 text-[13px] text-slate-600 dark:text-slate-300">
                      <li className="flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5 text-[#84CC16] shrink-0"/> {t.pm_feat_ads_3}</li>
                  ...
                  <div className="bg-slate-900 dark:bg-slate-900 rounded-2xl p-5 border border-slate-800 flex flex-col shadow-lg relative ring-2 ring-[#84CC16]">
                    ...
                    <ul className="space-y-2 mb-6 flex-1 text-[13px] text-slate-300 dark:text-slate-300">
                      <li className="flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5 text-[#84CC16] shrink-0"/> {t.pm_feat_ads_100}</li>
                  ...
                  {/* Agencia */}
                  <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-200 dark:border-slate-800 flex flex-col shadow-sm">
                    <h4 className="font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider text-[11px] mb-1">{t.pm_plan_agencia}</h4>
                    <p className="text-2xl font-black text-slate-950 dark:text-white mb-3"><span className="text-[12px] font-normal text-slate-400 dark:text-slate-500">{t.pm_from}</span> $1,499 <span className="text-[12px] font-normal text-slate-400 dark:text-slate-500">{t.pm_per_month}</span></p>
                    <ul className="space-y-2 mb-6 flex-1 text-[13px] text-slate-600 dark:text-slate-300">
                      <li className="flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5 text-[#84CC16] shrink-0"/> {t.pm_feat_ads_300_500}</li>
                      <li className="flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5 text-[#84CC16] shrink-0"/> {t.pm_feat_bulk_upload}</li>
                      <li className="flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5 text-[#84CC16] shrink-0"/> {t.pm_feat_api_access}</li>
                    </ul>
                ...
                <div className="bg-slate-100 dark:bg-slate-900 rounded-2xl p-4 text-center border border-slate-200 dark:border-slate-800">
                  <p className="text-[14px] font-semibold text-slate-700 dark:text-slate-300">{t.pm_pay_note}</p>
                </div>
              </div>
            ) : (
              <div className="space-y-6">
                <div className="max-w-4xl mx-auto bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4 shadow-sm">
                  <div className="flex flex-col md:flex-row md:items-center gap-3 justify-between">
                    <div>
                      <p className="text-[13px] font-bold text-slate-900 dark:text-white">{t.pm_promote_ad_label}</p>
                      <p className="text-[12px] text-slate-500 dark:text-slate-400">{t.pm_promote_ad_hint}</p>
                    </div>
                    <select
                      aria-label={t.pm_promote_ad_label}
                    ...
                    >
                      <option value="">{t.pm_select_active_ad}</option>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 flex flex-col shadow-sm">
                    <h4 className="font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-[12px] mb-4">{t.pm_boost_section}</h4>
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 flex flex-col shadow-sm">
                    <h4 className="font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-[12px] mb-4">{t.pm_premium_section}</h4>
                    <div className="space-y-4 flex-1">
                      <div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800 rounded-xl">
                        <div>
                ...
                <div className="max-w-4xl mx-auto bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm">
                  <h4 className="font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-[12px] mb-1">{t.pm_buy_credits_title}</h4>
                  <p className="text-[12px] text-slate-500 dark:text-slate-400 mb-4">{t.pm_buy_credits_desc}</p>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                    {[100, 200, 300, 500].map(v => (
                      ...
                      >
                        ...
                        <p className="text-[11px] text-slate-500 dark:text-slate-400">{t.pm_credits_unit} · ${v}</p>
                      </button>
                    ))}
                  </div>
                  <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
                    <div className="flex-1">
                      <label htmlFor="pricing-custom-credits-amount" className="text-[12px] font-semibold text-slate-600 dark:text-slate-300 mb-1 block">{t.pm_custom_amount}</label>
                      <input
                      ...
                      />
                      <p className="text-[11px] text-slate-400 mt-1">{t.pm_custom_amount_hint}</p>
                    </div>
                    <button
