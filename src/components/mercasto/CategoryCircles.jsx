  ...
  return (
    <section data-source-location="src/components/mercasto/CategoryCircles.jsx:19:4" data-dynamic-content="true" className="border-b border-border relative">
      <div data-source-location="src/components/mercasto/CategoryCircles.jsx:20:6" data-dynamic-content="true" className="mx-auto max-w-7xl relative">
        <div data-source-location="src/components/mercasto/CategoryCircles.jsx:21:8" data-dynamic-content="true" className="no-scrollbar flex gap-4 sm:gap-6 overflow-x-auto px-4 py-6 snap-x">
          {CATS.map(([cat, Icon, key]) =>
          <button data-source-location="src/components/mercasto/CategoryCircles.jsx:23:12" data-dynamic-content="true" key={cat} onClick={() => onSelect(cat)} className="flex flex-col items-center gap-2 shrink-0 snap-start w-20 sm:w-24 group">
              ...
              <span data-source-location="src/components/mercasto/CategoryCircles.jsx:27:14" data-dynamic-content="true" className="text-xs text-muted-foreground group-hover:text-foreground transition text-center">{t(key)}</span>
            </button>
          )}
        </div>
