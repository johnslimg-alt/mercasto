...
export default function MercastoGoldenHeader({
  ...
  return (
    ...
    <header className={`mcg-header ${search ? 'mcg-header-with-search' : ''}`} data-testid="golden-header">
      ...
      <button type="button" data-testid="golden-account-button" className="mcg-hicon" aria-label={accountLabel || t.open_account_menu || t.my_account || t.login || ''} onClick={onAccount}><Icon name="menu"/></button>
    </header>
    {search && (
