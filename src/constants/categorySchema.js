...
export const categorySchema = {
  ...
  turismo: { label: labels('Turismo', 'Tourism', {
    ...
    ['hospedaje', 'Hoteles y Hospedaje', 'Hotels & Lodging', {
      ...
      ar: 'الفنادق والإقامة',   ru: 'Отели и жилье', ja: 'ホテルと宿泊施設'
    }],
    ['tours', 'Tours y Viajes', 'Tours & Trips', {
      ...
      ar: 'الجولات والرحلات',   ru: 'Туры и путешествия', ja: 'ツアーと旅行'
    }],
    ['boletos_turismo', 'Boletos a Eventos', 'Event Tickets', {
      ...
      ar: 'تذاكر الفعاليات',   ru: 'Билеты на мероприятия', ja: 'イベントチケット'
    }],
    ['articulos_camping', 'Artículos de Viaje y Outdoor', 'Travel & Outdoor Gear', {
      ...
      ar: 'معدات السفر والهواء الطلق',   ru: 'Товары для туризма', ja: '旅行＆アウトドア用品'
    }],
    ['souvenirs', 'Souvenirs y Regalos', 'Souvenirs & Gifts', {
      ...
      ar: 'الهدايا التذكارية والهدايا',   ru: 'Сувениры и подарки', ja: 'お土産とギフト'
    }],
    ['renta_vehiculos', 'Renta de Transporte', 'Transport Rental', {
      ...
      ar: 'تأجير وسائل النقل',   ru: 'Аренда транспорта', ja: '交通機関レンタル'
    }],
    ['guias_servicios', 'Guías y Servicios', 'Guides & Services', {
      ...
      ar: 'المرشدين والخدمات',   ru: 'Гиды и услуги', ja: 'ガイドとサービス'
    }],
    ['atracciones_exp', 'Atracciones y Experiencias', 'Attractions & Experiences', {
      ...
      ar: 'المعالم السياحية والتجارب',   ru: 'Развлечения и опыт', ja: 'アトラクションと体験'
    }],
    ['retiros_bienestar', 'Retiros y Bienestar', 'Retreats & Wellness', {
      ...
      ar: 'المنتجعات الصحية والعافية',   ru: 'Ретриты и велнес', ja: 'リトリートとウェルネス'
    }],
  ] },
