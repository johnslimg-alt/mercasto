...
const COPY = Object.freeze({
  "es": {
    "seo": {
      ...
      "internalChats": "Conversaciones internas",
      "sellerReplies": "respuestas del vendedor",
      "sellerResponseRate": "Tasa de respuesta del vendedor",
      "within2h": "en menos de 2 h",
      "medianFirstResponse": "Mediana de primera respuesta",
      "returnAfter24h": "Retorno después de 24 h",
      "eligibleUsers": "usuarios elegibles",
      "minutes": "min",
      "responseRate": "Respuesta vendedor",
  ...
  "en": {
    "seo": {
      ...
      "internalChats": "Internal conversations",
      "sellerReplies": "seller replies",
      "sellerResponseRate": "Seller response rate",
      "within2h": "within 2 h",
      "medianFirstResponse": "Median first response",
      "returnAfter24h": "Return after 24h",
      "eligibleUsers": "eligible users",
      "minutes": "min",
      "responseRate": "Seller response",
  ...
  "pt": {
    "seo": {
      ...
      "sellerReplies": "respostas do vendedor",
      "sellerResponseRate": "Taxa de resposta do vendedor",
      "within2h": "em até 2 h",
      "medianFirstResponse": "Mediana da primeira resposta",
      "returnAfter24h": "Retorno após 24 h",
      "eligibleUsers": "usuários elegíveis",
      "minutes": "min",
      "responseRate": "Resposta do vendedor",
  ...
  "fr": {
    "seo": {
      ...
      "internalChats": "Conversations internes",
      "sellerReplies": "réponses vendeur",
      "sellerResponseRate": "Taux de réponse vendeur",
      "within2h": "en moins de 2 h",
      "medianFirstResponse": "Médiane de première réponse",
      "returnAfter24h": "Retour après 24 h",
      "eligibleUsers": "utilisateurs éligibles",
      "minutes": "min",
      "responseRate": "Réponse vendeur",
  ...
  "zh": {
    "seo": {
      ...
      "internalChats": "站内对话",
      "sellerReplies": "卖家回复",
      "sellerResponseRate": "卖家回复率",
      "within2h": "2 小时内",
      "medianFirstResponse": "首次回复中位时间",
      "returnAfter24h": "24 小时后回访率",
      "eligibleUsers": "符合条件的用户",
      "minutes": "分钟",
      "responseRate": "卖家回复率",
  ...
  "ko": {
    "seo": {
      ...
      "internalChats": "내부 대화",
      "sellerReplies": "판매자 답변",
      "sellerResponseRate": "판매자 응답률",
      "within2h": "2시간 이내",
      "medianFirstResponse": "첫 응답 중앙값",
      "returnAfter24h": "24시간 후 재방문",
      "eligibleUsers": "대상 사용자",
      "minutes": "분",
      "responseRate": "판매자 응답률",
  ...
  "de": {
    "seo": {
      ...
      "internalChats": "Interne Gespräche",
      "sellerReplies": "Verkäuferantworten",
      "sellerResponseRate": "Antwortrate Verkäufer",
      "within2h": "innerhalb 2 Std.",
      "medianFirstResponse": "Median erste Antwort",
      "returnAfter24h": "Rückkehr nach 24 Std.",
      "eligibleUsers": "berechtigte Nutzer",
      "minutes": "Min.",
      "responseRate": "Verkäuferantwort",
  ...
  "it": {
    "seo": {
      ...
      "internalChats": "Conversazioni interne",
      "sellerReplies": "risposte venditore",
      "sellerResponseRate": "Tasso di risposta venditore",
      "within2h": "entro 2 h",
      "medianFirstResponse": "Mediana prima risposta",
      "returnAfter24h": "Ritorno dopo 24 h",
      "eligibleUsers": "utenti idonei",
      "minutes": "min",
      "responseRate": "Risposta venditore",
  ...
  "ar": {
    "seo": {
      ...
      "internalChats": "المحادثات الداخلية",
      "sellerReplies": "ردود البائع",
      "sellerResponseRate": "معدل رد البائع",
      "within2h": "خلال ساعتين",
      "medianFirstResponse": "وسيط وقت الرد الأول",
      "returnAfter24h": "العودة بعد 24 ساعة",
      "eligibleUsers": "المستخدمون المؤهلون",
      "minutes": "دقيقة",
      "responseRate": "رد البائع",
  ...
  "ru": {
    "seo": {
      ...
      "internalChats": "Внутренние диалоги",
      "sellerReplies": "ответов продавца",
      "sellerResponseRate": "Доля ответов продавца",
      "within2h": "в течение 2 ч",
      "medianFirstResponse": "Медиана первого ответа",
      "returnAfter24h": "Возврат после 24 ч",
      "eligibleUsers": "подходящих пользователей",
      "minutes": "мин",
      "responseRate": "Ответ продавца",
  ...
  "ja": {
    "seo": {
      ...
      "internalChats": "内部会話",
      "sellerReplies": "出品者の返信",
      "sellerResponseRate": "出品者返信率",
      "within2h": "2時間以内",
      "medianFirstResponse": "初回返信の中央値",
      "returnAfter24h": "24時間後の再訪率",
      "eligibleUsers": "対象ユーザー",
      "minutes": "分",
      "responseRate": "出品者返信率",
