...
const copy = {
  es: {
    sellerNotFound: 'Este vendedor no existe.', loadError: 'Error al cargar el perfil.', back: 'Volver',
  ...
  en: {
    sellerNotFound: 'This seller does not exist.', loadError: 'Error loading the profile.', back: 'Back',
  ...
  pt: {
    sellerNotFound: 'Este vendedor não existe.', loadError: 'Erro ao carregar o perfil.', back: 'Voltar',
  ...
  fr: {
    sellerNotFound: "Ce vendeur n'existe pas.", loadError: 'Erreur lors du chargement du profil.', back: 'Retour',
  ...
  zh: {
    sellerNotFound: '此卖家不存在。', loadError: '加载个人资料时出错。', back: '返回',
  ...
  ko: {
    sellerNotFound: '판매자를 찾을 수 없습니다.', loadError: '프로필을 불러오는 중 오류가 발생했습니다.', back: '뒤로',
  ...
  de: {
    sellerNotFound: 'Dieser Verkäufer existiert nicht.', loadError: 'Fehler beim Laden des Profils.', back: 'Zurück',
  ...
  it: {
    sellerNotFound: 'Questo venditore non esiste.', loadError: 'Errore durante il caricamento del profilo.', back: 'Indietro',
  ...
  ar: {
    sellerNotFound: 'هذا البائع غير موجود.', loadError: 'حدث خطأ أثناء تحميل الملف الشخصي.', back: 'رجوع',
  ...
  ru: {
    sellerNotFound: 'Такого продавца не существует.', loadError: 'Не удалось загрузить профиль.', back: 'Назад',
  ...
  ja: {
    sellerNotFound: 'この販売者は存在しません。', loadError: 'プロフィールの読み込み中にエラーが発生しました。', back: '戻る',
